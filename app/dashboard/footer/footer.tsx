                        ...
                        <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
                            <li>
                                <a
                                    ...
                                    rel="noreferrer"
                                    target="_blank"
                                    className="text-indigo-400 transition hover:text-teal-700/75"
                                >
                    ...
                    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
                        ...
                        <div className="text-center sm:text-left">
                            ...
                            <ul className="mt-8 space-y-4 text-sm">
                                ...
                                <li>
                                    <a className="text-gray-700 transition hover:text-gray-700/75" href="#"> Web
                                        Design </a>
                                </li>
                                ...
                                <li>
                                    <a className="text-gray-700 transition hover:text-gray-700/75" href="#"> Google
                                        Ads </a>
                                </li>
                            </ul>
                        </div>
                ...
                <div className="mt-12 border-t border-gray-100 pt-6">
                    <div className="text-center sm:flex sm:justify-between sm:text-left">
                        <p className="text-sm text-gray-500">
                            ...
                            <a
                                className="inline-block text-indigo-400 underline transition hover:text-indigo-600/75"
                                href="#"
                            >
                                Terms & Conditions
                            </a>
